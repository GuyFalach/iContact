...
public:
	...
	static bool faceMouseConnector(Frame& newFrameGray, Frame& newFrameEdge, Frame& lastFrame, Mouse& mouse, Camera cam, float originalEyesInfo[2][3], bool& actionEnded, int& failCounter, unsigned int& noMovementCounter, bool& moveState, bool& clickFrame);
private:
