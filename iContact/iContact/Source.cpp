...
int main()
{
	...
	try
	{
		...
		while (true)
		{
			...
			if (ActivationFace::faceMouseConnector(gray, newEdgeFame, lastEdgeFrame, mouse, cam, eyesInfo, actionEnded, failCounter, movementCounter, moveStatus, clickFrame) == false)
			{
